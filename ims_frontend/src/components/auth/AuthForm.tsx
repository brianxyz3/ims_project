      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        { isSignUp &&
          ...
          <div className='relative'>
            ...
            <Input onChange={(evt) => handleInputChange(evt)} value={formData.firstName} autoComplete='first name' placeholder='John' id='firstName' name='firstName' className='pl-8'/>
          </div>
        </div>
        ...
        <div>
          ...
          <div className='relative'>
            <User2Icon className='size-5 absolute bottom-2 left-2'/>
            <Input onChange={(evt) => handleInputChange(evt)} value={formData.lastName} autoComplete='last name' placeholder='Doe' id='lastName' name='lastName' className='pl-8'/>
          </div>
        </div></>}
        ...
        <div>
          ...
          <div className='relative'>
            ...
            <Input type='email' onChange={(evt) => handleInputChange(evt)} value={formData.email} autoComplete='email' placeholder='name@gmail.com' id='email' name='email' className='pl-8'/>
          </div>
        </div>
        ...
        <div>
          ...
          {isSignUp && Boolean(passwordStrength) &&
            <>
        ...
        <Button size={"lg"} className='w-full bg-blue-700 mt-8'>{isSignUp? "Create Account" : "Log In To Account"}</Button>
